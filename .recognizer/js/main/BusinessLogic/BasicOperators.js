...
var __recognizer763002234 = (function () {
    'use strict';
...
var BusinessLogic = __recognizer763002234.logProbe([
        20,
        27,
        20,
        40
    ], __recognizer763002234.logProbe([
        20,
        20,
        20,
        26
...
(function (pContext, $) {
    __recognizer763002234.logEntry([
        26,
        1,
        26,
        9
    ...
    pContext.getBasicOperatorsBL = function () {
        ...
        return __recognizer763002234.logProbe([
            35,
            13,
            35,
            29
    ...
    var basicOperatorsBL = function () {
            ...
            function shiftRightByte(pByte, pNumPositionsMove) {
                ...
                var bitMoved;
                bitMoved = 255 >> __recognizer763002234.logProbe([
                    54,
                    33,
                    54,
                    50
                ], pNumPositionsMove) & __recognizer763002234.logProbe([
                    54,
                    54,
                    54,
                    59
            ...
            function reproduceChromosome(pByte1, pByte2) {
                ...
                var son = __recognizer763002234.logProbe([
                        65,
                        22,
                        65,
                        28
                    ], pByte1) & __recognizer763002234.logProbe([
                        65,
                        29,
                        65,
                        35
            ...
            function ckeckOnBit(pByte, pNumBit) {
                ...
                if ((__recognizer763002234.logProbe([
                        70,
                        16,
                        70,
                        21
                    ], pByte) & 1 << __recognizer763002234.logProbe([
                        70,
                        27,
                        70,
                        34
            ...
            function mutateBit(pByte, pNumBit) {
                ...
                if (__recognizer763002234.logProbe([
                        ...
                        79,
                        25
                    ], ckeckOnBit)(__recognizer763002234.logProbe([
                        79,
                        26,
                        79,
                        31
                    ], pByte), __recognizer763002234.logProbe([
                        79,
                        33,
                        79,
                        40
                    ], pNumBit))) == true) {
                    bitMutate = __recognizer763002234.logProbe([
                        80,
                        29,
                        80,
                        34
    ...
    97,
    15
], BusinessLogic), __recognizer763002234.logProbe([
    97,
    17,
    97,
    23
