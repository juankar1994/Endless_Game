...
var __recognizer325834061 = (function () {
    'use strict';
...
var BusinessLogic = __recognizer325834061.logProbe([
        20,
        27,
        20,
        40
    ], __recognizer325834061.logProbe([
        20,
        20,
        20,
        26
...
(function (pContext, $) {
    __recognizer325834061.logEntry([
        26,
        1,
        26,
        9
    ...
    pContext.getBasicOperatorsBL = function () {
        ...
        return __recognizer325834061.logProbe([
            35,
            13,
            35,
            29
    ...
    var basicOperatorsBL = function () {
            ...
            function shiftRightByte(pByte, pNumPositionsMove) {
                ...
                var bitMoved;
                bitMoved = 255 >> __recognizer325834061.logProbe([
                    51,
                    33,
                    51,
                    50
                ], pNumPositionsMove) & __recognizer325834061.logProbe([
                    51,
                    54,
                    51,
                    59
            ...
            function reproduceChromosome(pByte1, pByte2) {
                ...
                var son = __recognizer325834061.logProbe([
                        62,
                        22,
                        62,
                        28
                    ], pByte1) & __recognizer325834061.logProbe([
                        62,
                        29,
                        62,
                        35
            ...
            function ckeckOnBit(pByte, pNumBit) {
                ...
                if ((__recognizer325834061.logProbe([
                        67,
                        16,
                        67,
                        21
                    ], pByte) & 1 << __recognizer325834061.logProbe([
                        67,
                        27,
                        67,
                        34
            ...
            function mutateBit(pByte, pNumBit) {
                ...
                if (__recognizer325834061.logProbe([
                        ...
                        76,
                        25
                    ], ckeckOnBit)(__recognizer325834061.logProbe([
                        76,
                        26,
                        76,
                        31
                    ], pByte), __recognizer325834061.logProbe([
                        76,
                        33,
                        76,
                        40
                    ], pNumBit))) == true) {
                    bitMutate = __recognizer325834061.logProbe([
                        77,
                        29,
                        77,
                        34
    ...
    94,
    15
], BusinessLogic), __recognizer325834061.logProbe([
    94,
    17,
    94,
    23
